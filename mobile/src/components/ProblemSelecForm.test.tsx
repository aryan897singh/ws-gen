...
const MAX_PROMPT_CHAR_COUNT = 1000;
...
describe("ProblemSelecForm Component", () => {
  ...
  it("accepts a minimum of 1 total question", () => {
    ...
    const { getByTestId, getByText } = render(
      <ProblemSelecForm onGenerate={mockOnGenerate} MAX_PROBLEM_COUNT={MAX_PROBLEM_COUNT} MAX_PROMPT_CHAR_COUNT={MAX_PROMPT_CHAR_COUNT} />,
    );
    //scan and test
